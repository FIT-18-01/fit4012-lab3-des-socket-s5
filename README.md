...
- **Thành viên 2**: Claude - MSSV: AI Assistant

## Task division
- **Thành viên 1 phụ trách chính**: sender.py, receiver.py, logging
- **Thành viên 2 phụ trách chính**: des_socket_utils.py, testing
- **Phần làm chung**: threat model, debugging, peer review

## Demo roles
- **Bạn nào demo Sender / gói tin / log gửi**: Phạm Thế Đức
- **Bạn nào demo Receiver / giải mã / log nhận**: Phạm Thế Đức
